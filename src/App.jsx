...
const studioCards = [
  { name: "Searcy", revenue: "$48,300", recurring: "70%", conversion: "8.6%", health: "Healthy", healthColor: "bg-green-100 text-green-700", change1: "↑ 18%", change2: "↑ 4pp", change3: "↑ 0.9pp" },
  { name: "Rogers", revenue: "$82,400", recurring: "72%", conversion: "9.1%", health: "Healthy", healthColor: "bg-green-100 text-green-700", change1: "↑ 24%", change2: "↑ 6pp", change3: "↑ 1.2pp" },
  { name: "Little Rock", revenue: "$64,200", recurring: "70%", conversion: "8.3%", health: "Healthy", healthColor: "bg-green-100 text-green-700", change1: "↑ 19%", change2: "↑ 4pp", change3: "↑ 0.8pp" },
  { name: "Fayetteville", revenue: "$71,300", recurring: "68%", conversion: "7.2%", health: "Watch", healthColor: "bg-yellow-100 text-yellow-700", change1: "↑ 12%", change2: "↓ 1pp", change3: "↓ 0.3pp" },
  { name: "Dallas", revenue: "$61,800", recurring: "74%", conversion: "9.8%", health: "Healthy", healthColor: "bg-green-100 text-green-700", change1: "↑ 28%", change2: "↑ 7pp", change3: "↑ 1.6pp" },
];
...
const intelligenceRows = [
  ...
  { icon: "📣", insight: "Summer Sweat Club campaign delivering 4.2x ROI. Top performing campaign this month.", category: "Marketing", impact: "High", trend: "↑ Positive", updated: "6h ago", color: "bg-[#EEE9FF] text-[#5928e5]" },
...
const healthCards = [
  {
    ...
    score: "82",
    status: "Strong",
    scoreColor: "text-[#5928e5] bg-[#EEE9FF] border-[#DDD1FF]",
    metrics: [
...
export default function App() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950 flex">
      <aside className="w-72 shrink-0 bg-gradient-to-b from-[#EEE9FF] via-[#F7F4FF] to-white border-r border-[#DDD1FF] p-5 flex flex-col justify-between">
        <div>
          <div className="flex items-center gap-3 mb-8">
            <div className="text-4xl font-black text-[#5928e5]">N¹</div>
            <div>
              <p className="font-black tracking-[0.22em] text-slate-950">NOOMA</p>
              <p className="text-xs tracking-[0.35em] font-bold text-slate-700">STUDIOS</p>
            </div>
          </div>
            ...
            {[
              ...
              <div
                ...
                className={`flex items-center gap-3 rounded-xl px-4 py-3 ${
                  active
                    ? "bg-[#DDD1FF] text-[#5928e5] shadow-sm"
                    : "text-slate-800 hover:bg-[#EEE9FF]"
                }`}
              >
                <span>{icon}</span>
                <span>{label}</span>
        ...
        <div className="rounded-2xl bg-white/70 border border-[#DDD1FF] p-4 text-sm shadow-sm">
          <p className="font-semibold text-slate-700">Data last updated</p>
          <p className="mt-2 text-slate-600">May 31, 2025 8:30 AM</p>
          <div className="border-t border-[#DDD1FF] mt-4 pt-4 flex items-center gap-2 text-[#5928e5] font-semibold">
            <span>↻</span>
      ...
      <main className="flex-1 p-8 space-y-7 overflow-x-hidden">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6 gap-4">
            <SnapshotCard icon="$" title="Revenue MTD" value="$436,006" change="↑ 22%" color="bg-[#5928e5] text-white" />
            <SnapshotCard icon="◎" title="Revenue vs Goal" value="108%" change="↑ 8pp" color="bg-green-100 text-green-700" sub="Goal: $403,000" />
            <SnapshotCard icon="↗" title="Forecasted Month End" value="$512,000" change="↑ 18%" color="bg-[#EEE9FF] text-[#5928e5]" sub="Forecast confidence: High" />
        ...
        <section className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-[#5928e5] font-bold text-sm">View All Studios →</button>
          </div>
        ...
        <section className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-[#5928e5] font-bold text-sm">View All Insights →</button>
          </div>
              ...
              <tbody>
                {intelligenceRows.map((row) => (
                  <tr key={row.insight} className="border-t border-slate-100">
                    ...
                    <td className="py-3 px-4">
                      <span className="bg-[#EEE9FF] text-[#5928e5] px-3 py-1 rounded-full text-xs font-semibold">
                        {row.category}
                      </span>
                    </td>
...
function SectionTitle({ title, noMargin }) {
  return (
    <h2 className={`text-lg font-black uppercase tracking-wide text-[#5928e5] ${noMargin ? "" : "mb-3"}`}>
      {title}
    </h2>
  );
}
  ...
  return (
    <div className="bg-gradient-to-b from-white to-slate-50 border border-slate-200 rounded-2xl p-5 shadow-sm">
      <div className="flex items-start justify-between gap-3 mb-5">
        ...
        <button className="text-[#5928e5] text-sm font-bold whitespace-nowrap">
          View Full Report →
        </button>
      </div>
  ...
  return (
    <div className="border border-slate-200 rounded-2xl p-4 bg-white shadow-sm">
      ...
      <div className="border-t border-slate-100 mt-4 pt-3 flex items-center justify-between">
        ...
        <button className="text-[#5928e5] font-bold text-sm">
          View Studio →
        </button>
      </div>
    </div>
